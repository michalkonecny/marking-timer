...
(function($PS) {
  ...
  var showPad2 = function (dictShow) {
      return function (n) {
          ...
          var aux = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 158, column 3 - line 160, column 21): " + [  ]);
          })();
          return aux;
      };
  };
  ...
  var component = (function () {
      var render = function (v) {
          var timesN = Data_Functor.map(Data_Functor.functorArray)(function (v1) {
              return v1;
          })(v.times);
          ...
          var avg_time5 = Data_Time_Duration.Milliseconds(Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(Data_Array.take(avg_n5)(timesN)) / Data_Int.toNumber(avg_n5));
          var avg_time = Data_Time_Duration.Milliseconds(Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(timesN) / Data_Int.toNumber(avg_n));
          ...
          var startPauseButton = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 106, column 5 - line 108, column 72): " + [  ]);
          })();
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof Start) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (prevTick) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $32.isRunning = new Data_Maybe.Just({
                          prevTick: prevTick
                      });
                      return $32;
                  });
          ...
          if (v instanceof Pause) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $35.isRunning = Data_Maybe.Nothing.value;
                      return $35;
                  });
              });
          };
          if (v instanceof Done) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $38.isRunning = Data_Maybe.Nothing.value;
                      $38.time = 0.0;
                      $38.times = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.time ])(s.times);
                      return $38;
                  });
              });
          };
                  ...
                  if (v1.isRunning instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (thisTick) {
                          ...
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                              ...
                              $44.isRunning = new Data_Maybe.Just({
                                  prevTick: thisTick
                              });
                              $44.time = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(s.time)(v2);
                              return $44;
                          });
                      });
                  };
          ...
          throw new Error("Failed pattern match at Main (line 112, column 18 - line 137, column 23): " + [ v.constructor.name ]);
      };
