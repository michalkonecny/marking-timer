  ...
  var showPad2 = function (dictShow) {
      return function (n) {
          ...
          var aux = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 186, column 3 - line 188, column 21): " + [  ]);
          })();
          return aux;
      };
  };
  ...
  var component = (function () {
      var render = function (v) {
          ...
          var startPauseButton = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 120, column 5 - line 122, column 72): " + [  ]);
          })();
          return Halogen_HTML_Elements.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ startPauseButton ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text(showTime(v.time)) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ doneButton ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text("Avg of last " + (Data_Show.show(Data_Show.showInt)(avg_n5) + ":")) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text((function () {
              ...
              return "N/A";
          })()) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text("Recent times:") ]) ]) ])(timesRows));
      };
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage)))(function (s) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $34.m_storage = new Data_Maybe.Just(s);
                      return $34;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.getItem("times")(s)))(function (m_timesS) {
                          var m_times = parseTimes(m_timesS);
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              if (m_times instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (m_times instanceof Data_Maybe.Just) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      ...
                                      $38.times = m_times.value0;
                                      return $38;
                                  });
                              };
                              throw new Error("Failed pattern match at Main (line 133, column 7 - line 135, column 54): " + [ m_times.constructor.name ]);
                          })())(function () {
          ...
          if (v instanceof Start) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (prevTick) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $42.isRunning = new Data_Maybe.Just({
                          prevTick: prevTick
                      });
                      return $42;
                  });
          ...
          if (v instanceof Pause) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $45.isRunning = Data_Maybe.Nothing.value;
                      return $45;
                  });
              });
          };
          if (v instanceof Done) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var times$prime = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ v1.time ])(v1.times);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v1.m_storage instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          if (v1.m_storage instanceof Data_Maybe.Just) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.setItem("times")(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJNumber))(times$prime)))(v1.m_storage.value0));
                          };
                          throw new Error("Failed pattern match at Main (line 150, column 7 - line 152, column 89): " + [ v1.m_storage.constructor.name ]);
                      })())(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $51.isRunning = Data_Maybe.Nothing.value;
                              $51.time = 0.0;
                              $51.times = times$prime;
                              return $51;
                          });
                      });
                  });
                  ...
                  if (v1.isRunning instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (thisTick) {
                          ...
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                              ...
                              $61.isRunning = new Data_Maybe.Just({
                                  prevTick: thisTick
                              });
                              $61.time = extendTime(s.time);
                              return $61;
                          });
                      });
                  };
          ...
          throw new Error("Failed pattern match at Main (line 125, column 18 - line 165, column 23): " + [ v.constructor.name ]);
      };
