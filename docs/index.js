...
(function($PS) {
  ...
  var ResetHistory = (function () {
      ...
      ResetHistory.value = new ResetHistory();
      return ResetHistory;
  })();
  var Done = (function () {
      function Done() {
  ...
  var tickPeriodMs = 50.0;
  var ticker = Halogen_Query_EventSource.affEventSource(Effect_Aff_Class.monadAffAff)(function (emitter) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(tickPeriodMs))(function () {
          return Halogen_Query_EventSource.emit(emitter)(Tick.value);
      }))))(function (fiber) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Effect_Aff.killFiber(Effect_Exception.error("ticker: Event source finalized"))(fiber));
      });
  });
  var showPad2 = function (dictShow) {
      return function (n) {
          var nS = Data_Show.show(dictShow)(n);
          var nSlen = Data_String_CodePoints.length(nS);
          var aux = (function () {
              if (nSlen === 1) {
                  return "0" + nS;
              };
              ...
              throw new Error("Failed pattern match at Main (line 201, column 3 - line 203, column 21): " + [  ]);
          })();
          return aux;
      };
  };
  var showTime = function (mt) {
      var v = Data_Time.adjust(Data_Time_Duration.durationMilliseconds)(mt)(Data_Bounded.bottom(Data_Time.boundedTime));
      return Data_Show.show(Data_Show.showInt)(Data_Enum.fromEnum(Data_Time_Component.boundedEnumHour)(v.value1.value0)) + (":" + (showPad2(Data_Show.showInt)(Data_Enum.fromEnum(Data_Time_Component.boundedEnumMinute)(v.value1.value1)) + (":" + showPad2(Data_Show.showInt)(Data_Enum.fromEnum(Data_Time_Component.boundedEnumSecond)(v.value1.value2)))));
  };
  var parseTimes = function (m_timesS) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(m_timesS)(function (timesS) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Either.hush(Data_Argonaut_Decode_Parser.parseJson(timesS)))(function (json) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Either.hush(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonNumber))(json)))(function (times) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(times);
              });
          });
      });
  };
  var initialState = {
      isRunning: Data_Maybe.Nothing.value,
      time: 0.0,
      times: [  ],
      m_storage: Data_Maybe.Nothing.value
  };
  var component = (function () {
    
      // _ -> pure unit
  var updateLocalStorage = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          if (v.m_storage instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v.m_storage instanceof Data_Maybe.Just) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.setItem("times")(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonJNumber))(v.times)))(v.m_storage.value0));
          };
          throw new Error("Failed pattern match at Main (line 174, column 7 - line 176, column 88): " + [ v.m_storage.constructor.name ]);
      });
      var render = function (v) {
          var timeRow = function (t) {
              return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(showTime(t)) ]) ]);
          };
          var timesRows = Data_Functor.map(Data_Functor.functorArray)(timeRow)(v.times);
          var timeCSSclass = (function () {
              var v1 = v.time === 0.0;
              if (v.isRunning instanceof Data_Maybe.Just) {
                  return "isRunning";
              };
              if (v1) {
                  return "isNotRunning";
              ...
              throw new Error("Failed pattern match at Main (line 128, column 20 - line 131, column 30): " + [ v.isRunning.constructor.name, v1.constructor.name ]);
          })();
          var avg_n = Data_Array.length(v.times);
          var avg_n5 = Data_Ord.min(Data_Ord.ordInt)(5)(avg_n);
          var avg_time5 = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(Data_Array.take(avg_n5)(v.times)) / Data_Int.toNumber(avg_n5);
          var avg_time = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(v.times) / Data_Int.toNumber(avg_n);
          var actionButton = function (v1) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v2) {
                  return new Data_Maybe.Just(v1.action);
              }) ])([ Halogen_HTML_Core.text(v1.label) ]);
          };
          var doneButton = actionButton({
              action: Done.value,
              label: "Done"
          });
          var resetHistoryButton = actionButton({
              action: ResetHistory.value,
              label: "Reset history"
          });
          var startPauseButton = (function () {
              if (Data_Maybe.isJust(v.isRunning)) {
                  return actionButton({
                      action: Pause.value,
                      label: "Pause"
                  });
              ...
              throw new Error("Failed pattern match at Main (line 122, column 5 - line 124, column 72): " + [  ]);
          })();
          return Halogen_HTML_Elements.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ startPauseButton ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(timeCSSclass) ])([ Halogen_HTML_Core.text(showTime(v.time)) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ doneButton ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text("Avg of last " + (Data_Show.show(Data_Show.showInt)(avg_n5) + ":")) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text((function () {
              var $39 = avg_n5 > 0;
              if ($39) {
                  return showTime(avg_time5);
              };
              return "N/A";
          })()) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text("Avg of all " + (Data_Show.show(Data_Show.showInt)(avg_n) + ":")) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text((function () {
              var $40 = avg_n > 0;
              if ($40) {
                  return showTime(avg_time);
              };
              return "N/A";
          })()) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ resetHistoryButton ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text("Recent times:") ]) ]) ])(timesRows));
      };
      var readLocalStorage = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.getItem("times")(v.storage)))(function (m_timesS) {
              var m_times = parseTimes(m_timesS);
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.maybe(v["default"])(Control_Category.identity(Control_Category.categoryFn))(m_times));
          });
      };
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage)))(function (storage) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(readLocalStorage({
                      storage: storage,
                      "default": [  ]
                  }))(function (times) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $48.m_storage = new Data_Maybe.Just(storage);
                          $48.times = times;
                          return $48;
                      }))(function () {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(ticker));
                      });
                  });
              });
          };
          if (v instanceof Start) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (prevTick) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $51.isRunning = new Data_Maybe.Just({
                          prevTick: prevTick
                      });
                      return $51;
                  });
          ...
          if (v instanceof Pause) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $54 = {};
                      for (var $55 in v1) {
                      ...
                      $54.isRunning = Data_Maybe.Nothing.value;
                      return $54;
                  });
              });
          };
          if (v instanceof Done) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(Tick.value))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $57.isRunning = Data_Maybe.Nothing.value;
                      $57.time = 0.0;
                      $57.times = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.time ])(s.times);
                      return $57;
                  }))(function () {
          ...
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.isRunning instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (thisTick) {
                          var v2 = Data_DateTime.diff(Data_Time_Duration.durationMilliseconds)(Data_DateTime_Instant.toDateTime(thisTick))(Data_DateTime_Instant.toDateTime(v1.isRunning.value0.prevTick));
                          var extendTime = function (time) {
                              var v3 = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(time)(v2);
                              return v3;
                          };
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                              ...
                              $67.isRunning = new Data_Maybe.Just({
                                  prevTick: thisTick
                              });
                              $67.time = extendTime(s.time);
                              return $67;
                          });
                      });
                  };
          ...
          throw new Error("Failed pattern match at Main (line 133, column 18 - line 169, column 23): " + [ v.constructor.name ]);
      };
  ...
  exports["Done"] = Done;
  exports["tickPeriodMs"] = tickPeriodMs;
  exports["component"] = component;
  exports["ticker"] = ticker;
  exports["showTime"] = showTime;
  exports["showPad2"] = showPad2;
})(PS);
PS["Main"].main();